...
moonloopd tx moonloop create-powerup-template "bulldogs" "english" "wakeup" "Wakeup" "Let's wake up the cute little guy. 10 power will do the trick." 0 10upower 1000upower 10 10 60 100 1 1upower 1upower 0 "" --from lynn --yes
