...
type App struct {
	*baseapp.BaseApp
	...
	MoonloopKeeper moonloopmodulekeeper.Keeper
...
func New(
	...
	app.MoonloopKeeper = *moonloopmodulekeeper.NewKeeper(
		appCodec,
	...
	app.mm.SetOrderInitGenesis(
		...
		moonloopmoduletypes.ModuleName,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(moonloopmoduletypes.ModuleName)
