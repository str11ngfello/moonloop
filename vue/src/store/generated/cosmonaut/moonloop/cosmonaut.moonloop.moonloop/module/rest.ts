...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/cosmonaut/moonloop/moonloop/class
   */
  queryClassAll = (
    query?: {
    ...
    this.request<MoonloopQueryAllClassResponse, RpcStatus>({
      path: `/cosmonaut/moonloop/moonloop/class`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cosmonaut/moonloop/moonloop/class/{collectionIndex}/{classIndex}
   */
  queryClass = (collectionIndex: string, classIndex: string, params: RequestParams = {}) =>
    this.request<MoonloopQueryGetClassResponse, RpcStatus>({
      path: `/cosmonaut/moonloop/moonloop/class/${collectionIndex}/${classIndex}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/cosmonaut/moonloop/moonloop/collection
   */
  queryCollectionAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<MoonloopQueryAllCollectionResponse, RpcStatus>({
      path: `/cosmonaut/moonloop/moonloop/collection`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cosmonaut/moonloop/moonloop/contribution
   */
  queryContributionAll = (
    ...
    this.request<MoonloopQueryAllContributionResponse, RpcStatus>({
      path: `/cosmonaut/moonloop/moonloop/contribution`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cosmonaut/moonloop/moonloop/contribution/{collectionIndex}/{classIndex}/{powerupTemplateIndex}/{instanceIndex}
   */
  queryContribution = (
    collectionIndex: string,
    classIndex: string,
    ...
    this.request<MoonloopQueryGetContributionResponse, RpcStatus>({
      path: `/cosmonaut/moonloop/moonloop/contribution/${collectionIndex}/${classIndex}/${powerupTemplateIndex}/${instanceIndex}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/cosmonaut/moonloop/moonloop/mintStrategy
   */
  queryMintStrategyAll = (
    ...
    this.request<MoonloopQueryAllMintStrategyResponse, RpcStatus>({
      path: `/cosmonaut/moonloop/moonloop/mintStrategy`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cosmonaut/moonloop/moonloop/powerup
   */
  queryPowerupAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<MoonloopQueryAllPowerupResponse, RpcStatus>({
      path: `/cosmonaut/moonloop/moonloop/powerup`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cosmonaut/moonloop/moonloop/powerup/{collectionIndex}/{classIndex}/{powerupTemplateIndex}/{instanceIndex}
   */
  queryPowerup = (
    collectionIndex: string,
    classIndex: string,
    ...
    this.request<MoonloopQueryGetPowerupResponse, RpcStatus>({
      path: `/cosmonaut/moonloop/moonloop/powerup/${collectionIndex}/${classIndex}/${powerupTemplateIndex}/${instanceIndex}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/cosmonaut/moonloop/moonloop/powerupTemplate
   */
  queryPowerupTemplateAll = (
    ...
    this.request<MoonloopQueryAllPowerupTemplateResponse, RpcStatus>({
      path: `/cosmonaut/moonloop/moonloop/powerupTemplate`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/cosmonaut/moonloop/moonloop/powerupTemplate/{collectionIndex}/{classIndex}/{powerupTemplateIndex}
   */
  queryPowerupTemplate = (
    ...
    this.request<MoonloopQueryGetPowerupTemplateResponse, RpcStatus>({
      path: `/cosmonaut/moonloop/moonloop/powerupTemplate/${collectionIndex}/${classIndex}/${powerupTemplateIndex}`,
      method: "GET",
      format: "json",
      ...params,
    });
